# modules/cloud_workflows/vectorindex_workflow/main.tf

resource "google_workflows_workflow" "vectorindex" {
  name            = "${var.prefix}-vectorindex-workflow"
  project         = var.project_id
  region          = var.region
  description     = "Vector indexing workflow for process documents"
...
main:
  ...
  steps:
    ...
    - return_success:
        return:
          status: "success"
          message: "Vector indexing workflow completed"
