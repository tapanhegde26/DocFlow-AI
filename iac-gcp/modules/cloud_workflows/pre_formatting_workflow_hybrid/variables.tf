# modules/cloud_workflows/pre_formatting_workflow_hybrid/variables.tf
...
# GKE service URLs (internal cluster DNS)
variable "text_extraction_url" {
  description = "URL of the text extraction GKE service"
  type        = string
}

variable "semantic_chunking_url" {
  description = "URL of the semantic chunking GKE service"
  type        = string
}
